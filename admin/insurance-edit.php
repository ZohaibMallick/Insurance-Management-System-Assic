            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 text-white">Insurance Modify</h1>
                ...
                <div class="card-body">
                    <?php
                        include '../db.php';
                        $id = $_GET['id'];
                        $sql = "SELECT * FROM insurance_tbl where id='$id'";
                    ...
                    <form action="updatei.php" method="POST">
                           ...
                           <br>
                            ...
                            <select class="form-control" name="category">
                                ...
                                <label>Premium</label>
                               <input type="number" name="premium" value="<?php echo $row['premium'] ?>" class="form-control" readonly><br>
                               <label>Basic</label>
                               <input type="number" name="basic" value="<?php echo $row['basic'] ?>" class="form-control" readonly><br>
