            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 text-white">Policy</h1>
...
WHERE i.uname = '$name' AND inc.category = 'Travel';
";
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                     <div class="card-body">
                                        ...
                                        FROM insurance_ap_tbl i
                                        INNER JOIN insurance_tbl inc ON i.pname = inc.pname
                                        WHERE i.uname = '$name' AND inc.category = 'Car';
                                        ";
                                        $result = mysqli_query($con,$sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                                    ...
                                    <div class="card-body">
                                     ...
                                     <?php 
                                        ...
                                        $sql = "SELECT COUNT(*) AS count
                                            FROM insurance_ap_tbl i
                                            INNER JOIN insurance_tbl inc ON i.pname = inc.pname
                                            WHERE i.uname = '$name' AND inc.category = 'Bike';
                                            ";
                                        $result = mysqli_query($con,$sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
                             ...
                             <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                     <div class="card-body">
                                        ...
                                        FROM insurance_ap_tbl i
                                        INNER JOIN insurance_tbl inc ON i.pname = inc.pname
                                        WHERE i.uname = '$name' AND inc.category = 'Health';
                                        ";
                                        $result = mysqli_query($con,$sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ?>
...
$query = "SELECT name, month, SUM(amount_paid) as total_amount
          FROM payment_tbl where name='$name' group by month,name order by id desc ";
